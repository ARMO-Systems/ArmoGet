...
namespace MoreLinq
{
    public static partial class MoreEnumerable
    {
        ...
        ///     Thrown if either <paramref name="sequence" /> or <paramref name="newSegmentPredicate" /> are
        ///     <see langword="null" />.
        /// </exception>
        ...
        /// <param name="newSegmentPredicate">
        ///     A function, which returns <c>true</c> if the given current element, previous element
        ///     indicate a new segment, and <c>false</c> otherwise
        /// </param>
        /// <returns>A sequence of segment, each of which is a portion of the original sequence</returns>
        /// <exception cref="ArgumentNullException">
        ///     Thrown if either <paramref name="sequence" /> or <paramref name="newSegmentPredicate" /> are
        ///     <see langword="null" />.
        /// </exception>
        public static IEnumerable< IEnumerable< T > > Segment< T >( this IEnumerable< T > sequence, Func< T, T, bool > newSegmentPredicate )
        {
            if ( sequence == null )
                throw new ArgumentNullException( "sequence" );
            if ( newSegmentPredicate == null )
            ...
            return SegmentImpl( sequence, ( item1, item2, index ) => newSegmentPredicate( item1, item2 ) );
        }
